import pytest
from function2 import Movie, is_higher_5_5, filter_movies_by_imdb_higher_5_5, filter_movies_by_categories, average_movies_imdb, average_movies_imdb_by_categories
