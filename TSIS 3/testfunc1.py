import pytest
from function1 import gram_to_ounce, fahrenheit_centigrade, get_chicken_and_rabbit_count, is_prime, filter_primes, get_permutations, reverse_words, has_33, spy_game, circle_volume, unique_list, is_palindrome, histogram, guess_number_validate
